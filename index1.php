...
<!-- Mirrored from bytesed.com/tf/indurance/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Sep 2022 13:53:13 GMT -->
                                            ...
                                            <li class="mail-part">
                                                ...
                                                <div class="mail-us-text">
                                                    ...
                                                    <span class="details"><a
                                                            ...
                                                            class="__cf_email__"
                                                            data-cfemail="01686f676e416479606c716d642f626e6c">[email&#160;protected]</a></span>
                                                </div>
                                            </li>
                                        </ul>
                                        <div class="icon-part">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="indurance-feature-item">
                        ...
                        <div class="feature-content">
                            ...
                            <h5 class="title">best chemical research industry</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="indurance-feature-item">
                        ...
                        <div class="feature-content">
                            ...
                            <h5 class="title">best mechanical engineering industry</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="indurance-feature-item">
                        ...
                        <div class="feature-content">
                            ...
                            <h5 class="title">best civil engineering industry</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-5">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="v-pills-piping-tab" data-toggle="pill" href="#v-pills-piping" role="tab"
                            aria-controls="v-pills-piping" aria-selected="false">
                            <div class="tab-list-icon">
                                <i class="fa fa-exchange"></i>
                            </div>
                            <div class="tab-list-content">
...
?>
    ...
    <section class="services-section padding-bottom-85">
        <div class="container">
                            ...
                            <div class="col-sm-6">
                                <div class="indurance-about-item">
                                    ...
                                    <div class="about-content">
                                        <h6 class="title">expert engineer</h6>
    ...
    <section class="quote-section padding-120" style="background-image: url('assets/images/home-01/quote-bg.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                            ...
                            <div class="col-lg-9">
                                <ul class="info-bottom-right">
                                    <li class="call-us-part white">
                                        ...
                                        <div class="content">
                                            <h4 class="title">call us</h4>
                                            <span class="detials">+91 458 654 528</span>
                                        </div>
                                    </li>
                                    <li class="mail-part white">
                                        ...
                                        <div class="content">
                                            ...
                                            <span class="details"><a
                                                    href="https://bytesed.com/cdn-cgi/l/email-protection"
                                                    class="__cf_email__"
                                                    data-cfemail="9bf2f5fdf4dbfee3faf6ebf7feb5f8f4f6">[email&#160;protected]</a></span>
                                        </div>
                                    </li>
...
<!-- Mirrored from bytesed.com/tf/indurance/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Sep 2022 13:53:16 GMT -->
