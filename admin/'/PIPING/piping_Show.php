...
<html lang="en">
    ...
    <div class="container">
        <div class="row"  style="color:white;margin-top:70px;">
          ...
          <div class="col-sm-4 text-center">
                   <center> <h2><b>PIPING DESIGN</b></h2></center>
                    <span class="text-muted">HEAT VENTILATION AIR CONDITIONING</span>
          </div>
 ...
 <div class="row justify-content-end">
       <div class="col-sm-3">
        <a href="piping_Add.php" class="btn btn-dark w-100">ADD DETAILS</a>
       </div>
  </div>
 </div>
