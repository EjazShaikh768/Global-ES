  ...
  <div class="container" style="margin-top:3%;">
    <div class="row justify-content-center" >
        <div class="card p-5 col-sm-12 col-md-10 col-lg-9 shadow p-3 mb-5 bg-body rounded">
                  <div class="card-title text-center" style="text-decoration:underline;"> <h1><b>MEP REVIT</b></h1></div>
                  <form action="saveData2.php" method="post" enctype="multipart/form-data">
                      <div class="row d-flex">
                       ...
                       <!-- <div class="col-lg-12 form-group">
                        ...
                        <textarea type="text" class="form-control" rows="4" cols="50"  name="point1"></textarea>
                       </div> -->
                       <!-- <div class=" col-lg-6 form-group">
...
$sql = "SELECT * FROM multipleimages";
...
<img src="../upload/<?php echo $row['imagename']; ?>" alt="">
