  ...
  <!-- <img src="../images/hvac.jpg" alt="" style="postion:absolute; height:200px;"> -->
    <div class="container">
        <div class="row"  style="color:white;margin-top:70px;">
          ...
          <div class="col-sm-4 text-center">
                   <center> <h2><b>INQUIRY FORM</b></h2></center>
          </div>
...
?>
    <tr>
      ...
      <td> <?php  if ($row['inquiryStatus'] == 1) {
                                echo '<p> <a href="inquiryStatus.php?sssts1='.$row['id'].'&status=0 "><i class="fa-solid mt-4 fa-circle-check fa-3x text-info"></i></a> </p>';
                             }else {
                                echo '<p> <a href="inquiryStatus.php?sssts1='.$row['id'].'&status=1 "><i class="fa-solid mt-4 fa-circle-xmark fa-3x text-warning"></i></a> </p>';
                            } ?> </td>
     </tr>
     <?php } } ?>
  </tbody>
