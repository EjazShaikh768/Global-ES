...
<html lang="en">
  ...
  <div class="container" style="margin-top:3%;">
    ...
    include '../db.php';
    $id = $_GET['edit'];
 $sql = "SELECT * FROM sub_section  WHERE ss_id = '{$id}' ";
...
?>
                  <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            <img  src="../upload/<?php echo $row1['sub_saction_image']; ?>" height="150px" width="100%">
                            <input type="file" class="form-control mt-3 " name="new-image">
                            <input type="hidden" name="old-image"  value="<?php echo $row1['sub_saction_image']; ?>">
                        </div>
                            <div class="form-group">
                                <label for="title">DESCRIPTION</label>
                                <textarea type="text" rows="4" cols="50"  class="form-control" name="description"> <?php echo $row1['sub_saction_description']; ?> </textarea>
                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "UPDATE sub_section SET sub_saction_name = '{$title}', sub_saction_image = '{$new_name}' ,sub_saction_description= '{$description}' WHERE ss_id = '{$id}' ";
